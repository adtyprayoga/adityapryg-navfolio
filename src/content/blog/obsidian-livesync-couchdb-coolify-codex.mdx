---
title: 'Obsidian LiveSync on Coolify: CouchDB Setup'
seoTitle: 'Obsidian LiveSync on Coolify: CouchDB Setup'
description: 'My Obsidian LiveSync setup with CouchDB on Coolify, HTTPS, E2EE, and LiveSync CLI to make a Markdown vault available to Codex on my server.'
date: 2026-09-25
...
I run Obsidian LiveSync with CouchDB on Coolify so my notes stay synchronized
across devices and are available as Markdown on my coding server. LiveSync CLI
connects the server vault to the database, while Codex reads those notes during
development. This is also my setup record for reinstalling or checking the system.
